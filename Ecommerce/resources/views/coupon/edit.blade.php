                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-control">
                                    <option {{ ($coupon->type == 'percent') ? 'selected' : '' }} value="percent">Percentage</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $coupon->expire_at }}"  autocomplete="off" type="text" name="expires_at" id="expires_at" class="form-control" placeholder="Expires At">
                                <p></p>		
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{ $coupon->description }}</textarea>                                <p></p>	
                            </div>
                        </div>  										
                    </div>
                </div>							
