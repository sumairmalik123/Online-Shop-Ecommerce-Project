                        ...
                        @if ($product->product_images)
                            @foreach ($product->product_images as $key => $image)
                                <div class="carousel-item {{ ($key == 0) ? 'active' : '' }}">
                                    <img class="w-100 h-100" src="{{ asset('uploads/category/product/large/'.$image->image) }}" alt="Product Image">
                                </div>
                            @endforeach          
                        @endif
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="products-rating-error text-danger"></p>
                            ...
                            <div class="col-md-12 mt-5">
                                ...
                                @if ($product->product_ratings->isNotEmpty())
                                    @foreach ($product->product_ratings as $key => $rating)
                                    @php
    ...
    $.ajax({
        ...
        success: function(response){
           ...
           if (response.status == true) {
            ...
            if (errors.rating) {
                $(".products-rating-error").html(errors.rating);
            } else {
                $(".products-rating-error").html("");
            }
           }
        }
