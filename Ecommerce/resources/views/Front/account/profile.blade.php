...
<div class="card mt-5">
    ...
    <div class="mb-3">
        ...
        <input value="{{ (!empty($address)) ? $address->last_name : '' }}" type="text" name="last_name" id="last_name" placeholder="Enter Last Your Name" class="form-control">
        <p></p>
        </div>
    <div class="mb-3">
    <label for="email">Email</label>
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input value="{{ (!empty($address)) ? $address->apartment : '' }}" type="text" name="appartment" id="appartment" placeholder="Appartment" class="form-control">
                <p></p>
                </div>
      ...
      success: function(response){
        if (response['status'] == true) {
          ...
          if (errors.appartment){
            $("#apartment").addClass('is-invalid').siblings('p').html(errors.appartment).addClass('invalid-feedback');
          } else {
            $("#apartment").removeClass('is-invalid').siblings('p').html('').removeClass('invalid-feedback');
          }
          if (errors.city){
