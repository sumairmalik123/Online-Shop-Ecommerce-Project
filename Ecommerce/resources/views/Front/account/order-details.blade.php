                                    ...
                                    <div class="col-6 col-lg-3">
                                        ...
                                        <p class="mb-lg-0 fs-sm fw-bold">
                                            <time datetime="2019-10-01">
                                                {{ \Carbon\Carbon::parse($order->created_at)->format('d,M,Y') }}                                            </time>
                                        </p>
                                    </div>
                                    <div class="col-6 col-lg-3">
                                        <!-- Heading -->
                                ...
                                <div class="row align-items-center">
                                    <div class="col-4 col-md-3 col-xl-2">
                                        ...
                                        @endphp
                                         ...
                                         <img class="img-fluid" src="{{ asset('uploads/category/product/large/'.$productImage->image) }}" class="img-thumbnail">
                                     @else
                                         <img src="{{ asset('temp/1715515329.png') }}" class="img-fluid" >
                                     @endif
                                    </div>
                                    <div class="col">
                                        <!-- Title -->
                                        <p class="mb-4 fs-sm fw-bold">
                                            <a class="text-body" href="product.html">{{ $item->name }} x {{ $item->quantity }}</a> <br>
                ...
                <div class="card card-lg mb-5 mt-3">
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li class="list-group-item d-flex">
                                    <span>Discount {{ (!empty($order->coupon_code)) ? '('.$order->coupon_code.')': 'F' }}</span>
